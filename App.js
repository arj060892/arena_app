...
const list_act = require('./src/icons/home_act.png');
const list_deact = require('./src/icons/home_deact.png');

const contact_act = require('./src/icons/contact_act.png');
const contact_deact = require('./src/icons/contact_act.png');

const menu_list_act = require('./src/icons/menu_list_deact.png');
